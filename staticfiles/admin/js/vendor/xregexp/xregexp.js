  ...
  })()(
    {
      1: [
        function (require, module, exports) {
          ...
          var _interopRequireDefault = require("@babel/runtime-corejs3/Utils/interopRequireDefault");
          ...
          var _slicedToArray2 = _interopRequireDefault(
            require("@babel/runtime-corejs3/Utils/slicedToArray")
          );
          ...
          function _createForOfIteratorUtil(o, allowArrayLike) {
            var it =
          ...
          var _default = function _default(XRegExp) {
            ...
            XRegExp.addUnicodeData = function (data, typePrefix) {
              ...
              var _iterator = _createForOfIteratorUtil(data),
                _step;
        ...
        },
        {
          ...
          "@babel/runtime-corejs3/Utils/interopRequireDefault": 24,
          "@babel/runtime-corejs3/Utils/slicedToArray": 27,
        },
      ],
      2: [
        function (require, module, exports) {
      ...
      4: [
        function (require, module, exports) {
          ...
          function prepareFlags(pattern, flags) {
            ...
            var _iterator = _createForOfIteratorUtil(flags),
              _step;
          ...
          XRegExp.addToken = function (regex, handler, options) {
            ...
            if (optionalFlags) {
              ...
              var _iterator2 = _createForOfIteratorUtil(optionalFlags),
                _step2;
          ...
          XRegExp.matchChain = function (str, chain) {
            return (function recurseChain(values, level) {
              ...
              var _iterator3 = _createForOfIteratorUtil(values),
                _step3;
          ...
          XRegExp.replaceEach = function (str, replacements) {
            var _iterator4 = _createForOfIteratorUtil(replacements),
              _step4;
          ...
          XRegExp.union = function (patterns, flags, options) {
            ...
            var _iterator5 = _createForOfIteratorUtil(patterns),
              _step5;
...
*/
      ...
      110: [
        function (require, module, exports) {
          ...
          // this Util broken in `core-js@3.4.1-3.4.4`, so we can't use `shared` Util
      ...
      153: [
        function (require, module, exports) {
          ...
          // Util for a popular repeating case of the spec:
